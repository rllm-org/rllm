...
<ParamField path="algorithm.adv_estimator" type="string" default="grpo">
  Advantage estimator: `grpo`, `reinforce`, `reinforce_plus_plus_baseline`, `rloo`, or `minus_length_weighted_mean`
</ParamField>
