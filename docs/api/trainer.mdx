...
<Note>
The verl/fireworks-specific legacy trainer lives at
`rllm.trainer.agent_trainer.AgentTrainer` and remains supported for the
`fireworks` backend. New code should prefer the unified
`from rllm.trainer import AgentTrainer`.
</Note>
