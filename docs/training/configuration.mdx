...
All configuration files are located in `rllm/trainer/config/unified/`:

- `rllm/trainer/config/unified/rllm/base.yaml`: Backend-agnostic rLLM configurations
- `rllm/trainer/config/unified/rllm/backend/tinker.yaml`: Tinker-specific configurations
- `rllm/trainer/config/unified/rllm/backend/verl.yaml`: Verl-specific configurations
- `rllm/trainer/config/unified/unified.yaml`: Main entry point that combines all configs
...
Tinker-specific settings live in `rllm/trainer/config/unified/rllm/backend/tinker.yaml`.
...
Verl-specific settings live in `rllm/trainer/config/unified/rllm/backend/verl.yaml`.
