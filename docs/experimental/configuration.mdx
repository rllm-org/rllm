...
- `rllm.algorithm.{adv_estimator,norm_adv_by_std_in_grpo}`
...
rllm:
  algorithm:
    adv_estimator: ${oc.select:algorithm.adv_estimator, grpo}  # Uses 'rloo'
    norm_adv_by_std_in_grpo: ${oc.select:algorithm.norm_adv_by_std_in_grpo, true}  # Uses false
```
