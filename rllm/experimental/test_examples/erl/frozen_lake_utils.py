"""FrozenLake-specific constants and callables for the ERL experiment.

Ported from the original ERL codebase (Shi et al., 2026).  Both the Verl and
Tinker entry points import from here.
"""
...
def prepare_frozenlake_datasets(train_size: int = 10000, test_size: int = 100):
    """Generate and register FrozenLake train/test datasets."""
