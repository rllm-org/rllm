"""Helpers for the FireworksBackend, mirroring verl's config-sync structure."""
...
# Shared Fireworks/rLLM aliases. Some native paths are runtime inputs; the rest
# preserve legacy native CLI overrides. Group sizes are already linked by YAML
# interpolation. Model, optimizer, model-context, and infrastructure settings have
# no equivalent rLLM key and intentionally stay Fireworks-only.
# Each tuple is (fireworks_native_path, rllm_path).
