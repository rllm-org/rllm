...
from rllm.engine.verl_utils.data_classes import AccumulatedData, CompactFilteringConfig, ProcessedStepData
...
def _batch_tensors_and_build_data_proto(accumulated: AccumulatedData, pad_token_id: int, max_prompt_length: int, max_response_length: int, cf_config: CompactFilteringConfig) -> "DataProto":
...
def transform_workflow_episodes_for_verl(
    ...
    return _batch_tensors_and_build_data_proto(accumulated, pad_token_id, max_prompt_length, max_response_length, cf_config)
