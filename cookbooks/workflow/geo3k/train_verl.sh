#!/usr/bin/env bash
# Train Geo3KWorkflow (legacy Workflow API) via the unified trainer + verl backend.
#
# Prerequisites:
...
python -u train.py \
    ...
    trainer.project_name=geo3k_workflow \
    trainer.experiment_name=qwen3-vl-30b-instruct-verl \
