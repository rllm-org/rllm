...
_DEFAULT_REMOTE_RETRIES = _read_nonnegative_int_env("SWE_REX_REMOTE_RETRIES", 2)
_SOCK_CONNECT_TIMEOUT_S = _read_positive_float_env("SWE_REX_REMOTE_SOCK_CONNECT_TIMEOUT_S", 5.0)
