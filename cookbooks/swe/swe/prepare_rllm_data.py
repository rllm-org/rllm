#!/usr/bin/env python3
"""Prepare SWE data for rLLM training.

Registers datasets in rllm DatasetRegistry. The entire dataset is registered
as-is; train/val assignment happens in the training launcher.

Usage:
    python -m swe.prepare_rllm_data --dataset swe_smith
...
def prepare_rllm_data(dataset_name: str, split: str = "train"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare SWE data for rLLM training")
    ...
    prepare_rllm_data(args.dataset, args.split)
