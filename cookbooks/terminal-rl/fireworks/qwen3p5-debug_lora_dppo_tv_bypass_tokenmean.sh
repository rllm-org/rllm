...
#   bash cookbooks/terminal-rl/fireworks/qwen3p5-debug_lora_dppo_tv_bypass_tokenmean.sh
# Override anything by appending Hydra args, e.g.:
#   bash cookbooks/terminal-rl/fireworks/qwen3p5-debug_lora_dppo_tv_bypass_tokenmean.sh fireworks_config.rollout_deployment_replica_count=4
# Reattach an existing rollout deployment (it is still deleted at shutdown):
#   bash cookbooks/terminal-rl/fireworks/qwen3p5-debug_lora_dppo_tv_bypass_tokenmean.sh fireworks_infra.deployments.rollout.deployment_id=accounts/rllm-project/deployments/<id>
