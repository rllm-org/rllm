...
python -u train_debug.py \
    ...
    model.lora_rank=0 \
    fireworks_config.policy_trainer_shape_id=accounts/rllm-project/trainingShapes/qwen3p6-35b-a3b-256k-fp32-master-weight-optimizer-states \
    ...
    rllm.trainer.experiment_name='qwen3p5-35b-a3b-fp32-master-weight-optimizer-states-eps-tb-v2-debug' \
